  ...
  return (
    <section className="relative pt-20 pb-16 bg-gradient-to-br from-slate-50 via-white to-indigo-50">
      ...
      <div className="relative z-10">
        ...
        {/* Categories Grid */}
        <div className="container w-11/12 md:w-4/5 mx-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
          {categories.map((category) => (
            <div
              ...
              "
            >
              <p className="capitalize text-sm md:text-base font-medium text-gray-800 hover:text-indigo-600">
                {category.name}
              </p>
            </div>
          ))}
